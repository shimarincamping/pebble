  ...
  return (
    <section className={`${styles.leaderboardSidebar__sidebarItem}`}>
      ...
      <img
        ...
        alt="user profile"
      />
      <div className={`${styles.leaderboardSidebar__sidebarItem__content}`}>
      ...
      <hr />
      <div className={`${styles.leaderboardSidebar__sidebarItem__content}`}>
        <p className={`${styles.leaderboardSidebar__sidebarItem__bioHeader}`}>
          Bio
        </p>
        <p className={`${styles.leaderboardSidebar__sidebarItem__bioBody}`}>
          {props.bio}
        </p>
      </div>
      <button className={`${styles.leaderboardSidebar__sidebarItem__button}`}>
        Read More
      </button>
    </section>
  );

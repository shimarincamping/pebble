...
function CodingChallengePageContainer() {
    ...
    const handleFetchData = async () => {
        ...
        const fetchedData = await fetch(
            `${process.env.REACT_APP_API_URL}/coding-challenges`,
            {
                method: "GET",
                headers: {
    ...
    const initCodingQuestionData = async (id) => {
        ...
        const fetchedData = await fetch(
            `${process.env.REACT_APP_API_URL}/coding-challenges/${id}`,
            {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
        ...
        setCurrentQuestionIndex(
            currentQuizList[id].lastAnsweredQuestion >=
    ...
    const handleAnswerSubmit = () => {
        ...
        if (
            ...
            currentQuizList[currentQuiz].lastAnsweredQuestion
        ) {
            ...
            fetch(
                `${process.env.REACT_APP_API_URL}/coding-challenges/${currentQuiz}/user-progress`,
                {
                    method: "POST",
                    body: JSON.stringify({
                    ...
                    <>
                        {Object.keys(currentQuizList).map((quiz, index) => (
                            <CodingChallengePreview
                                ...
                                codingDescription={
                                    currentQuizList[quiz].quizDescription
                                }
                                codingLevel={
                                    currentQuizList[quiz].quizDifficulty
                                }
